...
window.addEventListener("load", function(){
    ...
    if(message){
        message.innerHTML='<strong>Open Earth Engine toolbox Annual Survey</strong>\
            ...
            <br>The end of year is close, and it\'s time for small <a target="_blank" href="https://forms.gle/rKfSgF1zJ5NWhCMb6" style="color: hsl(120deg 100% 31%); font-weight: bold;">survey</a>. Please let us know about your experience with the Open Earth Engine Library and extension. '
